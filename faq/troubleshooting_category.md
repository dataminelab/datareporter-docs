...
1. **Your database** - DataReporter passes the query AS IS and it's your database's responsibility to handle your query
...
> **Note:** IMPORTANT TO NOTE: The relevant size (for DataReporter) is the size of the results.
