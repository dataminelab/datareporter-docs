...
> **Warning:** The CSV data source used in this tutorial has been replaced. You can find instructions for the new one [here]({% link _kb/data-sources/querying/csv-excel-files %}). You can still use the deprecated source by manually adding it to your installation. The source code is available under the same license as DataReporter at [this link](https://gist.github.com/susodapop/d367ff6c02f19ef4b9964e1042ca1d92).
...
> **Danger:** If you did this already, go to step 2.
...
> **Info:** Only admins can add data sources.
...
> **Warning:** If you aren't certain, leave the
...
![Screenshot of GitHub CSV preview](/docs/images/gitbook/csv-preview.png)

So you might need to dig a little for the right link.

![Screenshot of raw CSV file in browser](/docs/images/gitbook/raw-csv.png)

Shortcuts for a few common providers appear below.

## Dropbox

![Example of Dropbox Permissions](/docs/images/gitbook/dropbox-share-settings.png)
...
![Example of Dropbox Permissions](/docs/images/gitbook/google-share-settings.png)
...
![Example of OneDrive Embed Settings](/docs/images/gitbook/onedrive-embed-settings.png)
...
![Example of iCloud Share Settings](/docs/images/gitbook/icloud-share-settings.png)
...
![Screenshot of network inspector](/docs/images/gitbook/icloud-inspector.png)
...
> **Info:** The exact subdomain varies but is always prefixed with `ck`
> (for CloudKit)
...
# Step 3: Pull the data into DataReporter

![Screenshot of query screen with URL pasted](/docs/images/gitbook/query-example.png)
...
> **Info:** DataReporter expects a CSV file with a header as the first
> row.

The CSV data is now available to DataReporter. If everything looks correct click
**Save**. Then copy the query ID from the URL bar.

# Step 4: Query the data with QRDS

![Screenshot of QRDS query](/docs/images/gitbook/qrds-query-example.png)
...
> **Info:** It makes sense to used `cached_query` instead of `query`
...
It's rare to see errors once the data is successfully added to DataReporter in step 3. Most errors occur in step 2.
