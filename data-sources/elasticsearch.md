...
> **Danger:** The DataReporter ES connector was a community contribution from several years ago.
...
DataReporter supports two flavors of Elasticsearch queries, Lucene/string style
...
DataReporter has two data sources available for Elasticsearch. You need to use the
