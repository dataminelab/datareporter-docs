...
![](/docs/images/gitbook/atsd_user_group.png)
...
![](/docs/images/gitbook/atsd_user.png)

## Create Data Source

1. Login into DataReporter web interface.
...
|        Metric Limit        |      5000     |    No    |                                    Maximum number of ATSD [metrics](https://github.com/axibase/atsd-docs/blob/master/api/meta/metric/list.md#query-parameters) displayed as tables in DataReporter.                                    |
...
![](/docs/images/gitbook/atsd_datasource.png)
...
![](/docs/images/gitbook/atsd_query.jpg)
