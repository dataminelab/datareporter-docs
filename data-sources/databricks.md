...
DataReporter can connect to both Databricks clusters and SQL Endpoints. Consult the [Databricks Documentation](https://docs.databricks.com/integrations/bi/jdbc-odbc-bi.html#get-server-hostname-port-http-path-and-jdbc-url) for how to obtain the **Host**, **HTTP Path**, and an **Access Token** for your endpoint.

![Databricks Data Source Setup Screen](/docs/images/databricks-setup-screen.png)
...
![Databricks Data Source Setup Screen](/docs/images/databricks-schema-browser.png)
...
> **Info:** Only one table of query results can be displayed from a query.
