...
![](/docs/images/gitbook/new-viz.png)
...
It's easy to embed DataReporter visualizations. Just click the elipsis button beneath
any visualization to show further options and select `Embed Elsewhere`.

<img src="/docs/images/gitbook/embed-viz.png" width="60%">
...
- `?hide_header` hides the branded DataReporter header and query title
- `?hide_link` hides the link back to DataReporter
...
<img src="/docs/images/gitbook/download_viz.png" width="60%">
