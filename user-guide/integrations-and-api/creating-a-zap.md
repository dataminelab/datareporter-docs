...
You can connect DataReporter to Zapier and trigger an action every time a new line is
...
Here's a short example of connecting DataReporter to Zapier and creating a new Zap:

1. Use
   [this invitation](https://zapier.com/developer/invite/32785/4910e4da7931a8f3a2124ebd85cc352b/)
   link for the beta DataReporter trigger app (create an account if needed) and click
   "Make a Zap" right next to your account area at the top of the page.
2. Choose a trigger app - in this case, DataReporter (it won't be available to you
...
3. Choose a trigger - for now, we have only "New Query Results" in there, this
   ...
   frequency in Zapier.
4. Connect your DataReporter account to Zapier:
   1. Full domain of your DataReporter account (Something like:
      `https://app.redash.io/myorg/` or `https://redash.myorg.com/` (note the
      slash at the end))
   2. Your User ID - go to DataReporter settings and hover over your username on the
      **Users** tab. The number in the URL just after /users/ is your User ID,
      i.e. `https://app.redash.io/myorg/users/{user id}`. > **Warning:** You must be a member of the admin group to see the users list.
   3. API key - also in your user settings, select the API KEY tab and copy it
      from there ![](/docs/images/gitbook/user_api_key.png)
...
![](/docs/images/gitbook/zapier_slack_template_wider.png)

**Test your connection and turn your zap on!**

![](/docs/images/gitbook/zappy_bot.png)
