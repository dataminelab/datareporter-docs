...
<img src="/docs/images/gitbook/schema-browser.png" width="60%">
...
> **Note:** Please note that not all data source types support loading the schema.
...
> **Note:** Live Auto Complete is enabled by default unless your database schema exceeds five thousand tokens (tables or columns). In such cases, you can manually trigger Auto Complete using the keyboard shortcut.
...
> **Info:** Publishing or un-publishing a query does not affect its visibility.
> All queries in your organization are visible to all logged-in users.

## Archiving a Query

You can't delete queries in DataReporter. But you can archive them. Archiving is like deleting, except **direct links to the query still work.** To archive a query, open the vertical ellipsis menu at the top-right of the query editor and click Archive.

![](/docs/images/gitbook/archive_query.png)
...
![](/docs/images/gitbook/experimental-permissions-button.png)
