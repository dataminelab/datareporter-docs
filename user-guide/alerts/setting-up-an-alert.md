...
> **Warning:** Alerts don't work for queries with parameters.
...
![](/docs/images/gitbook/alert_settings_V9.png)

> **Info:** If a target query returns multiple records, DataReporter Alerts only see the first
...
- `UNKNOWN` means DataReporter does not have enough data to evaluate the alert
...
DataReporter sends notifications to your chosen Alert Destinations whenever it detects
...
If the notification frequency is set to _Just Once_, DataReporter would send a
