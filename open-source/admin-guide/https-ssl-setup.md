...
> **Important:** The instructions below are for the legacy images. If you use the new Docker based images, see the following guide:
> 
...
If you setup includes another proxy/load balancer in front of DataReporter's nginx, you will need to add the following header to your nginx configuration to make sure it knows the correct protocol in use:
