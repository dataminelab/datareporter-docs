...
If you want to work only on the frontend side of DataReporter, and have a DataReporter
...
The `REDASH_BACKEND=""` part of the command sets the URL of your remote DataReporter
server.
